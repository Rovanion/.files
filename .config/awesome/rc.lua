...
globalkeys = gears.table.join(
   awful.key({ modkey,           }, "Tab",
    ...
    -- Window size
		awful.key({ modkey,         }, "a",          fn'awful.tag.incmwfact( 0.05)',          {description = "increase master width factor", group = "layout"}),
    awful.key({ modkey,         }, "e",          fn'awful.tag.incmwfact(-0.05)',          {description = "decrease master width factor", group = "layout"}),
		awful.key({ modkey,         }, "adiaeresis", fn'awful.tag.incmwfact( 0.05)',          {description = "increase master width factor", group = "layout"}),
    awful.key({ modkey,         }, "o",          fn'awful.tag.incmwfact(-0.05)',          {description = "decrease master width factor", group = "layout"}),
		-- Window juggling
		awful.key({ modkey, "Shift" }, "a",          fn'awful.tag.incnmaster( 1, nil, true)', {description = "increase the number of master clients", group = "layout"}),
    awful.key({ modkey, "Shift" }, "e",          fn'awful.tag.incnmaster(-1, nil, true)', {description = "decrease the number of master clients", group = "layout"}),
    awful.key({ modkey, "Mod1"  }, "a",          fn'awful.tag.incncol( 1, nil, true)',    {description = "increase the number of columns", group = "layout"}),
    awful.key({ modkey, "Mod1"  }, "e",          fn'awful.tag.incncol(-1, nil, true)',    {description = "decrease the number of columns", group = "layout"}),
    -- Switch layout
