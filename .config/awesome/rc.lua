...
beautiful.init("/home/rovanion/.config/awesome/themes/zenburn/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "e", function () run_or_raise("emacs", {name = "emacs@ThinkUbuntu"} ) end),
...
-- Be careful: we use keycodes to make it worksn on any keyboard layout.
