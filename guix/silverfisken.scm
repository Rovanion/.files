...
(use-service-modules nix desktop xorg pm cups desktop networking virtualization)
(use-package-modules package-management version-control web-browsers file-systems gnuzilla xdisorg mtools audio linux gnome admin emacs fonts xorg cups bash gtk vim wm password-utils certs shells)
